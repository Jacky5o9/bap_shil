<%@ page import="com.miage.mbds.Gender" %>
<!DOCTYPE html>
<html>
<head>
                ...
                <g:form resource="${this.user}" method="POST">
                    <fieldset class="form">
                        ...
                        <div class="fieldcontain required">
                            ...
                            <g:select from="${Gender.values()}" name="gender"/>
                        </div>

                        <div class="fieldcontain required">
                            <label for="weight">Weight
                                <span class="required-indicator">*</span>
                            </label><input type="number" name="weight" value="" min="0" required="" id="weight">
                        </div>

                        <div class="fieldcontain required">
                            <label for="dob">Date of birth
                                <span class="required-indicator">*</span>
                            </label><g:datePicker name="dob" value="${new Date()}"
                                                  noSelection="['':'-Choose-']"/>

                        </div>

                        <div class="fieldcontain">
                            <label for="illustrationUser">Illustration</label>
                            <input type="file" name="illustrationUser" id="illustrationUser"/>
                        </div>
                    </fieldset>
